...
class SpreadsheetService {
  ...
  public async appendMemberToSpreadsheet(member: Member): Promise<{
    ...
    // E Nomor WA, F Provinsi, G Kabupaten/Kota, H Kecamatan, I Jabatan,
...
`;
  ...
  /**
   * SPWN API Authentication Connector
   * Login menggunakan Users Sheet melalui backend API.
   */
  ...
  /**
   * Statistik anggota dari SPWN API
   */
