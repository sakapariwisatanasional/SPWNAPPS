      ...
      <main id="landing-top">
        ...
        <section id="landing-krida" className="scroll-mt-20 px-4 sm:px-6 py-12 sm:py-16 border-t border-white/10">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-end justify-between gap-4 mb-6"><div><div className="text-[9px] uppercase tracking-[.18em] text-fuchsia-300 font-black">Explore your skill</div><h2 className="mt-1 text-2xl sm:text-4xl font-black tracking-tight">Dari Potensi Jadi Aksi, Dari Karya Jadi Inspirasi.</h2><p className="mt-2 text-xs sm:text-sm text-slate-500 max-w-xl">Pilih Krida → pilih SKK → buka materi. Dibuat ringkas agar mudah dijelajahi dari ponsel.</p></div><button type="button" onClick={() => openReader()} className="hidden sm:flex items-center gap-1.5 text-xs font-bold text-fuchsia-300 hover:text-white cursor-pointer">Baca layar penuh <ArrowRight className="w-3.5 h-3.5" /></button></div>
