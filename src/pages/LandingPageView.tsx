...
import {
  ...
  Landmark, BookOpen, UtensilsCrossed, Calendar, ChevronRight,
  Search, Star, Tag, CheckCircle2, Layers, Award, LogIn, UserPlus,
  LayoutDashboard
} from 'lucide-react';
...
export const LandingPageView: React.FC<LandingPageViewProps> = ({
  ...
  return (
    <div className="w-full min-h-screen bg-slate-950 text-slate-100 selection:bg-emerald-500 selection:text-white overflow-hidden">
            ...
            {currentUser ? (
              ...
              <>
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-slate-500 font-semibold text-xs transition-all flex items-center gap-1.5 cursor-pointer"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-bold text-xs shadow-md shadow-emerald-950/20 transition-all flex items-center gap-1.5 cursor-pointer"
                >
      ...
      {/* HERO SECTION */}
      <section className="relative min-h-[90vh] flex items-center justify-center pt-28 pb-16 px-4 md:px-8">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8">
          <div className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-300 text-xs md:text-sm font-semibold shadow-lg backdrop-blur-md">
