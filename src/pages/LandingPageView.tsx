        ...
        <section className="relative px-4 sm:px-6 pt-10 sm:pt-16 pb-12 sm:pb-16 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto grid lg:grid-cols-[1.08fr_.92fr] items-center gap-10 lg:gap-14">
            <div className="text-center lg:text-left">
              ...
              <h1 className="mt-5 text-[2.65rem] sm:text-5xl lg:text-[4.6rem] font-black tracking-[-.045em] leading-[.98]">Jelajahi. Berkarya.<br /><span className="bg-gradient-to-r from-fuchsia-300 via-violet-300 to-amber-200 bg-clip-text text-transparent">Jadi Bagian dari Pariwisata Indonesia.</span></h1>
              <p className="mt-5 max-w-xl mx-auto lg:mx-0 text-sm sm:text-base text-slate-400 leading-relaxed">Temukan Krida, pelajari skill baru, kenali destinasi, bagikan karya, dan ikut dalam berbagai aktivitas Saka Pariwisata.</p>
