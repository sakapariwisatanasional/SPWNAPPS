...
import { LogIn, UserPlus, Users, CalendarDays, MapPin, ShoppingBag, Sparkles, ArrowRight } from "lucide-react";
...
export function LandingPageView({
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <header className="sticky top-0 z-20 bg-white/90 backdrop-blur border-b px-6 py-4 flex justify-between items-center">

        <div className="flex items-center gap-3">
          <SakaLogo size={56} variant="full" />
          <div>
            <h2 className="font-black text-blue-900">SAKA PARIWISATA</h2>
            <p className="text-xs text-slate-500">Platform Digital Nasional</p>
          </div>
        </div>
      ...
      <section className="p-6">
        <div className="relative overflow-hidden rounded-[40px] min-h-[520px] p-8 md:p-14 text-white shadow-2xl bg-gradient-to-br from-blue-900 via-blue-700 to-cyan-500">
          ...
          <div className="absolute inset-0 bg-[url('/hero-gatara-borobudur.png')] bg-cover bg-center opacity-25" />
          ...
          <div className="relative z-10 max-w-3xl">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              >
                <UserPlus size={18}/> Daftar Anggota
              </button>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 border shadow-sm">
          ...
          <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-5 mt-6">
            ...
            {kridaList.map((krida) => (
              ...
              >
                <div className="text-4xl">{krida.icon}</div>
