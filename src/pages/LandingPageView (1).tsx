...
<Section title="Official Store Saka Pariwisata">
...
<p className="text-teal-600 mt-2 font-bold">
...
<button
onClick={()=>onSelectTab?.("official-store")}
className="mt-5 rounded-full bg-emerald-700 text-white px-6 py-3 font-bold"
>
Lihat Semua Produk
</button>
