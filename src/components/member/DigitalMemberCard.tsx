...
export const DigitalMemberCard: React.FC<Props> = ({ member, onEditCard, onPrintPdf, showControls=true, allowAdminEdit=false, previewSettings }) => {
  ...
  // 380px tetap menjadi batas maksimum desktop. Pada layar kecil preview
  // otomatis menyusut mengikuti lebar container tanpa mengubah rasio KTA.
  const widthPx = 380;
  ...
  return <div className="flex flex-col items-center gap-3 select-none">
    <div
      className="w-full max-w-[380px] cursor-pointer overflow-hidden"
      style={{aspectRatio: `${ratio}`, perspective: '1000px'}}
