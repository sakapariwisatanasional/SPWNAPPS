...
interface KtaQrScannerModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const KtaQrScannerModal: React.FC<KtaQrScannerModalProps> = ({
  isOpen,
  onClose,
  onScanSuccess,
  localMembers
  ...
  const readerElementId = 'kta-qr-html5-reader';
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      setIsVerifying(false);
      setErrorMsg('Tidak dapat mendeteksi QR Code dari gambar yang diunggah. Pastikan gambar jelas dan tidak buram.');
    }
  };
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-purple-200/70">
                Arahkan kamera ke QR Code pada Kartu Anggota
              </p>
            </div>
          </div>
          <button
                ...
                <div className="absolute inset-0 pointer-events-none flex items-center justify-center">
                  <div className="w-64 h-40 border-2 border-dashed border-emerald-400 rounded-xl bg-emerald-500/5 flex flex-col items-center justify-between p-2 shadow-[0_0_20px_rgba(16,185,129,0.3)]">
                    ...
                    <span className="text-[10px] font-bold text-emerald-300 bg-black/60 px-2 py-0.5 rounded backdrop-blur-xs">
                      Posisikan QR Code di Kotak Ini
                    </span>
                    <div className="w-full flex justify-between">
            ...
            <div className="p-3.5 bg-rose-950/60 border border-rose-500/50 rounded-2xl text-xs text-rose-200 flex items-start gap-2.5">
              ...
              <div className="space-y-1">
                ...
                <p className="text-[11px] text-rose-300/80">
                  Tip: Pastikan QR Code terlihat jelas atau masukkan nomor anggota secara manual pada kolom verifikasi.
                </p>
              </div>
            </div>
          )}
