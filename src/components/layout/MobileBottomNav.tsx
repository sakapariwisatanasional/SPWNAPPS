    ...
    <div className="app-mobile-nav lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200/90 px-2 py-1 shadow-xl safe-area-bottom">
      <nav className="flex items-center justify-around max-w-lg mx-auto">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 py-1.5 px-1 min-h-[48px] rounded-2xl transition-all cursor-pointer relative ${
        ...
        <button
          ...
          className="flex flex-col items-center justify-center flex-1 py-1.5 px-1 min-h-[48px] rounded-2xl text-slate-600 hover:text-fuchsia-700 transition-all cursor-pointer"
          aria-label="Menu Lengkap"
        >
          <div className="w-8 h-8 rounded-lg bg-slate-100 hover:bg-fuchsia-50 flex items-center justify-center">
