...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <div className="app-mobile-nav lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-slate-200/90 px-2 py-1 shadow-2xl safe-area-bottom">
      <nav className="flex items-center justify-around max-w-lg mx-auto">
        ...
        >
          <Compass className={`w-5 h-5 ${currentTab === 'tours' ? 'text-purple-700 stroke-[2.5]' : 'text-slate-400'}`} />
        ...
        >
          <div className="relative">
            <Utensils className={`w-5 h-5 ${currentTab === 'culinary-souvenirs' ? 'text-purple-700 stroke-[2.5]' : 'text-slate-400'}`} />
